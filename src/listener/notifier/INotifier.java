 ...
 * <p>
 * For an example of usage, see KeyboardWatchdog, where key-codes are mapped on
 * several Notifiers and just the appropriate Notifier is applied to all
 * listeners in KeyboardWatchdog#keyPressed(int, char) and
 * KeyboardWatchdog#keyReleased(int, char).
 * </p>
 * 
 * @author Daniel
 * 
